...
values
  ('team-thunder', 'default', 'Chaos Thunder',  'THU', null),
  ('team-reign',   'default', 'Midnight Reign',  'MID', null),
  ('team-blitz',   'default', 'Prairie Blitz',   'PRB', null),
  ('team-surge',   'default', 'Coastal Surge',   'CST', null)
